...
@section('title', 'delete_Result')

@section('content')

    <div class="d-flex justify-content-between">
        <h1 style=" margin-left: 1%"; class="text-muted"> Delete result </h1>
    ...
    <div class="custome-container">
        <div class="row">
            <div class="col-md-6 ">
                <form method="POST" action="{{route('page_deleteresult')}}" class="row g-4" id="form-register-patient">
                    @csrf
                    <div class="col-md-6">
