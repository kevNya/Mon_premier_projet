...
@section('content')
    ...
    <div class="custome-container">
        <div class="row">
            <div class="col-md-6 ">
                <form method="POST" action="{{route('page_updateresult')}}" class="row g-4" id="form-register-patient">
                    @csrf
                    <div class="col-md-6">
                        <label for="resultat_id" class="form-label">Result code</label>
                        <input type="number" class="form-control" id="resultat_id" name="resultat_id" value="{{old('resultat_id')}}" required autocomplete="resultat_id" autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="id_examen" name="id_examen" value="{{old('id_examen')}}" required autocomplete="id_examen" readonly>
                    ...
                    <div class="col-md-6 text-muted">
                        ...
                        <input type="datetime-local" class="form-control" id="Date_h_resultat" name="Date_h_resultat" value="{{old('Date_h_resultat')}}" required autocomplete="Date_h_resultat" readonly>
                        <small class="text-danger" id="error-Date_h_resultat"></small>
                    </div>

                    <div class="col-md-12 text-muted">
                        <label for="description" class="form-label">Text</label>
                        <input type="text" style="height: 10em; vertical-align: top;" class="form-control" id="description" name="description" value="NULL" required autocomplete="description" readonly>
