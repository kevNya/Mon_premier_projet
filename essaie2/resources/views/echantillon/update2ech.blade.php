...
@section('content')
    ...
    <div class="custome-container">
        <div class="row">
            <div class="col-md-6 ">
                <form method="POST" action="{{route('page_updateech2')}}" class="row g-4" id="form-register-patient">
                    @csrf
                    <div class="col-md-6">
                        <label for="echantillon_id" class="form-label">Code of sample</label>
                        <input type="number" class="form-control" id="echantillon_id" name="echantillon_id" value="{{$dataEch->echantillon_id}}" required autocomplete="echantillon_id" readonly>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="examen" name="examen" value="{{$dataEch->examen}}" required autocomplete="examen" autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" class="form-control" id="Date_h_reception" name="Date_h_reception" value="{{$dataEch->Date_h_reception}}" required autocomplete="Date_h_reception" autofocus>
                        <small class="text-danger" id="error-Date_h_reception"></small>
                    </div>
                    <div class="col-md-12">
                        <label for="commentaire" class="form-label">Comment </label>
                        <input type="text" style="height: 10em; vertical-align: top;" class="form-control" id="commentaire" name="commentaire" value="{{$dataEch->commentaire}}" required autocomplete="commentaire" autofocus>
                        <small class="text-danger" id="error-commentaire"></small>
                    </div>
                    <div class="col-md-6">
                        <label for="patient_id" class="form-label">Patient code </label>
                        <input type="number" class="form-control" id="patient_id" name="patient_id" value="{{$dataEch->patient_id}}"
