...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <h1 style=" margin-left: 1%"; class="text-muted">Edit a sample </h1>
        <h5 class="text-warning clignotant">Please enter code of sample for updating</h5>
    ...
    <div class="custome-container">
        <div class="row">
            <div class="col-md-6 ">
                <form method="POST" action="{{route('page_updateech')}}" class="row g-4" id="form-register-patient">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12 text-muted">
                        ...
                        <input type="text" class="form-control" id="examen" name="examen" value="{{old('examen')}}" required autocomplete="examen" readonly>
                    ...
                    <div class="col-md-6 text-muted">
                        ...
                        <input type="datetime-local" class="form-control" id="Date_h_reception" name="Date_h_reception" value="{{old('Date_h_reception')}}" required autocomplete="Date_h_reception" readonly>
