...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <h1 style=" margin-left: 1%"; class="text-muted"> Update patient </h1>
        <h5 class="text-warning clignotant">Please enter patient coder for modification</h5>
    ...
    <div class="custome-container">
        <div class="row">
            <div class="col-md-6 ">
                <form method="POST" action="{{route('page_updatpatient')}}" class="row g-4" >
                    @csrf

                    <div class="col-md-6">
                        <label for="coder" class="form-label">Code</label>
                        <input type="text" class="form-control" id="coder" name="coder"   value="" required autocomplete="coder" >
                        <small class="text-danger" id="error-coder"></small>
                    </div>
                    <div class="col-md-6 text-muted">
                        <label for="Nomm" class="form-label">Name</label>
                        <input type="text" class="form-control" id="Nomm" name="Nomm" value="" required autocomplete="Nomm" readonly>
                        <small class="text-danger" id="error-Nomm"></small>
                    </div>
                ...
                <div class="col-md-4" >
                    <div class="card-sm mb-1 text-center " >
                        <div style="height: 60px;" class="card-header ">
                            ...
                            <a href="" class=" text-decoration-none changeupdate">
