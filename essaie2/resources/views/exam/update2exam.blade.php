...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <h1 style=" margin-left: 1%"; class="text-muted"> Edit exam </h1>
    ...
    <div class="custome-container">
        <div class="row">
            <div class="col-md-6 ">
                <form method="POST" action="{{route('page_updateexam2')}}" class="row g-4" >
                    @csrf
                    <div class="col-md-6">
                        <label for="examen_id" class="form-label">Exam code</label>
                        <input type="text" class="form-control" id="examen_id" name="examen_id" value="{{$dataExam->examen_id}}" required autocomplete="examen_id" readonly>
                        <small class="text-danger" id="error-examen_id"></small>
                    </div>
                    <div class="col-md-6">
                        <label for="nom_examen" class="form-label">Exam Title </label>
                        <input type="text" class="form-control" id="nom_examen" name="nom_examen" value="{{$dataExam->nom_examen}}" required autocomplete="nom_examen" autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" class="form-control" id="Date_h_manipulation" name="Date_h_manipulation" value="{{$dataExam->Date_h_manipulation}}" required autocomplete="Date_h_manipulation" autofocus>
                        <small class="text-danger" id="error-Date_h_manipulation"></small>
                    </div>
                    <div class="col-md-6">
                        <label for="echantillon_id" class="form-label">Code of sample <i class="fas fa-venus fa-1x"></i><i class="fas fa-mars fa-1x"></i></label>
                        <input type="text" class="form-control" id="echantillon_id" name="echantillon_id" value="{{$dataExam->echantillon_id}}" required autocomplete="echantillon_id" autofocus>
                        <small class="text-danger" id="error-echantillon_id"></small>
                    </div>

                    <div class="col-md-12">
                        <label for="commentaire" class="form-label">Comment </label>
                        <input type="text" style="height: 10em; vertical-align: top;" class="form-control" id="commentaire" name="commentaire" value="{{$dataExam->commentaire}}" required autocomplete="commentaire" autofocus>
