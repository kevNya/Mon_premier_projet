...
@section('content')
    ...
    <div class="custome-container">
        <div class="row">
            <div class="col-md-6 ">
                <form method="POST" action="{{route('page_updateexam')}}" class="row g-4" >
                    @csrf
                    <div class="col-md-6">
                        <label for="examen_id" class="form-label">Exam code</label>
                        <input type="text" class="form-control" id="examen_id" name="examen_id" value="{{old('examen_id')}}" required autocomplete="examen_id" autofocus>
                        <small class="text-danger" id="error-examen_id"></small>
                    </div>
                    <div class="col-md-6">
                        <label for="nom_examen" class="form-label">Exam Title </label>
                        <input type="text" class="form-control" id="nom_examen" name="nom_examen" value="{{old('nom_examen')}}" required autocomplete="nom_examen" readonly>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="Date_h_manipulation" name="Date_h_manipulation" value="{{old('Date_h_manipulation')}}" required autocomplete="Date_h_manipulation" readonly>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="echantillon_id" name="echantillon_id" value="{{old('echantillon_id')}}" required autocomplete="echantillon_id" readonly>
                        <small class="text-danger" id="error-echantillon_id"></small>
                    </div>

                    <div class="col-md-12">
                        <label for="commentaire" class="form-label">Comment </label>
                        <input type="text" style="height: 10em; vertical-align: top;" class="form-control" id="commentaire" name="commentaire" value="NULL" required autocomplete="commentaire" readonly>
