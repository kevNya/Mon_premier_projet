...
/*$("#controlpassword").blur(function () {
    var password = $("#password").val();
    var controlpassword = $("#controlpassword").val();

    if (password == controlpassword && controlpassword != "") {
...
function emailExistjs(email) {
    var url = $("#email").attr("url_emailExist");
    ...
    $.ajax({
        ...
        success: function (result) {
            response = result.lareponse; // Ici, utilisez 'lareponse'
        },
        async: false,
    });
